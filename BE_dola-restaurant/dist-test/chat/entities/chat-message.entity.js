...
__decorate([
    (0, typeorm_1.ManyToOne)(() => chat_session_entity_1.ChatSession, { onDelete: 'CASCADE' }),
...
__decorate([
    (0, typeorm_1.Column)({ name: 'sender_type', type: 'enum', enum: ['customer', 'ai', 'staff'] }),
    __metadata("design:type", String)
], ChatMessage.prototype, "senderType", void 0);
__decorate([
    (0, typeorm_1.Column)({ name: 'sender_id', type: 'int', nullable: true }),
